...
export default {
  ...
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(sub => sub.setName("nick").setDescription("تغيير اسم").addUserOption(o => o.setName("عضو").setRequired(true)).addStringOption(o => o.setName("اسم").setRequired(true)))
    ...
    .addSubcommand(sub => sub.setName("report").setDescription("تبليغ").addUserOption(o => o.setName("عضو").setRequired(true))),
