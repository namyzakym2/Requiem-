...
export default {
  ...
  category: "economy",
  data: new SlashCommandBuilder().setName("confirm-transfer").setDescription("تأكيد عملية تحويل الرون").addStringOption((option) => option.setName("code").setDescription("كود التأكيد المكون من 6 أرقام").setRequired(true)),
  async executeInteraction(interaction, context) {
    ...
    if (commandName === "confirm-transfer") {
        ...
        await interaction.reply(`✅ تم تأكيد التحويل! تم تحويل **${pending.amount}** رون بنجاح إلى ${targetUser}.`);
