...
export default {
  name: "deposit",
  category: "economy",
  data: new SlashCommandBuilder().setName("deposit").setDescription("إيداع رون في البنك").addIntegerOption(o => o.setName("amount").setDescription("المبلغ").setRequired(true)),
  async executeInteraction(interaction, context) {
    ...
    await interaction.reply({ embeds: [new EmbedBuilder().setColor(0x22C55E).setDescription(`🏦 تم إيداع **${amount}** رون في البنك!`).setTimestamp()] });
  }
};
